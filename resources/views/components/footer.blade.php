...
<footer class="pt-16 pb-8" id="footer">
      ...
      <div class="mt-8">
        ...
        <details class="group">
          <summary class="flex items-center justify-between cursor-pointer hover:opacity-80 transition-opacity list-none p-4">
            ...
            <x-icons.svg.plus-sign class="w-3.5 h-3.5 transition-transform group-open:rotate-45 {{ $textColor }}" />
          </summary>
          <div class="px-4 pb-4">
    ...
    <div>
      ...
      <p class="text-xl {{ $textColor }} font-mono leading-relaxed mt-8">
      ...
      <div class="relative" style="
        ...
        <div class="relative h-11">
            ...
            <div class="flex items-center gap-3">
                ...
                <span class="text-sm text-nowrap {{ $fun ? 'text-fossil' : 'text-night-rider' }}">by Will King</span>
            </div>
            <div class="flex items-center gap-3">
